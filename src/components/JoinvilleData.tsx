...
const JoinvilleData = () => {
  return (
    <section className="section-spacing bg-white px-4 lg:px-0">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-card hover:shadow-hover transition-all card-hover">
            <div className="flex items-start mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 font-opensans font-light">
